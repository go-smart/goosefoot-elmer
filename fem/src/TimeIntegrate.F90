...
! *****************************************************************************/
! *  17/02/10: 
! *  - In BDFLocal(), multiplication of force term by coeff coming from BDF scheme
! *  (same coeff as for multiplication with stiffmatrix) 
! *****************************************************************************/
...
!------------------------------------------------------------------------------
     ...
     CASE(2)
       DO i=1,NB1
         ...
         END DO
         Force(i) = Force(i) + s
         !TODO:NUMA:Is this documented or worth documenting?
         !Force(i) = (2.d0/3.d0)*Force(i) + s
     ...
     CASE(5)
       DO i=1,NB1
         ...
         Force(i) = Force(i) + s
         !TODO:NUMA:Is this documented or worth documenting?
         !Force(i) = (60.d0/137.d0)*Force(i) + s
