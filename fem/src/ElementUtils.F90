...
#ifdef HAVE_TRILINOS
     IF (Matrix % TrilinosEpetra /= 0) THEN
       CALL SolveTrilinosEpetra4(Matrix % TrilinosEpetra)
     END IF
     IF (Matrix % TrilinosKokkos /= 0) THEN
       CALL SolveTrilinosKokkos4(Matrix % TrilinosEpetra)
     END IF
#endif
     DEALLOCATE( Matrix )
!------------------------------------------------------------------------------
